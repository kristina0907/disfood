            ...
            <div class="xs-12 col-md-8">
                <div class="right_container">
                    <div class="step_main_block">
                        ...
                        <div class="title_description_settings">Заполните данные профиля организации чтобы проводить
                            сделки
                        </div>
                        ...
                        <div v-if="step == 1">
                            <div class="step_profile_information_block">
                                <div class="step_name_profile_information">1. Модерация</div>
                            ...
                            <button class="btn_next_step" @click="changeStep">Далее • подписание договора</button>
                        </div>
                        <div v-if="step == 2">
                            <div class="step_profile_information_block">
                                <div class="step_name_profile_information">2. Договор</div>
                                <div class="step_description_profile_information">
                                    ...
                                    <div class="download_contract_block">
                                        ...
                                        <div class="container_download_contract_block">
                                            <div class="form-group">
                                                ...
                                                <label for="file" class="btn btn-tertiary js-labelFile">
                                                    <div class="container_info_download_contract">
                                                        <div class="name_download_contract">2. Название документа</div>
                                                        <div class="info_download_contract">Нажмите на ссылку “Загрузить”
                                                            или перетащите файл в эту область </div>
                                                        <div class="btn_download_contract">Загрузить</div>
                                                    </div>
                                        ...
                                        <div class="container_download_contract_block">
                                            <div class="form-group">
                                                ...
                                                <label for="file" class="btn btn-tertiary js-labelFile">
                                                    <div class="container_info_download_contract">
                                                        <div class="name_download_contract">3. Название документа</div>
                                                        <div class="info_download_contract">Нажмите на ссылку “Загрузить”
                                                            или перетащите файл в эту область </div>
                                                        <div class="btn_download_contract">Загрузить</div>
                                                    </div>
                                        ...
                                        <div class="container_download_contract_block">
                                            <div class="form-group">
                                                ...
                                                <label for="file" class="btn btn-tertiary js-labelFile">
                                                    <div class="container_info_download_contract">
                                                        <div class="name_download_contract">4. Название документа</div>
                                                        <div class="info_download_contract">Нажмите на ссылку “Загрузить”
                                                            или перетащите файл в эту область </div>
                                                        <div class="btn_download_contract">Загрузить</div>
                                                    </div>
                                        ...
                                        <div class="container_download_contract_block">
                                            <div class="form-group">
                                                ...
                                                <label for="file" class="btn btn-tertiary js-labelFile">
                                                    <div class="container_info_download_contract">
                                                        <div class="name_download_contract">5. Название документа</div>
                                                        <div class="info_download_contract">Нажмите на ссылку “Загрузить”
                                                            или перетащите файл в эту область </div>
                                                        <div class="btn_download_contract">Загрузить</div>
                                                    </div>
                        ...
                        <div v-if="step == 3">
                            <div class="step_profile_information_block">
                                <div class="step_name_profile_information">Вы аккредитованы как покупатель, теперь вы можете проводить сделки</div>
                                <div class="step_description_profile_information supplier_ifo_step">
                                    Чтобы стать поставщиком и размещать свои товары, пройдите оставшиеся этапы аккредитации
                                </div>
                            </div>
                            <div class="btn_step_block">
                                <router-link :to="{path:'/accreditation/provider'}" class="btn_become_supplier">
                                    Стать поставщиком
                                </router-link>
                                <router-link :to="{path:'/accreditation/success'}" class="btn_step_complete">
                                    Завершить
                                </router-link>
                            </div>
                        </div>
