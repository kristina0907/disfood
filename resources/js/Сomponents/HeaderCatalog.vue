<template>
    <header class="header_catalog scroll" >
        <nav class="navbar navbar-expand-lg">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <router-link class="nav-link" :to="{name:'delivery'}">Блог</router-link>
                    </li>
                    <li class="nav-item">
        ...
        <div class="container_header_catalog">
            <div class="header_catalog_items">
                <div class="container_btn_search_header">
                        <div class="catalog_menu" @click="sidebarExpand = true">
                            <span>
                            ...
                            <div type="button" class="item_list_sidebar_catalog_menu" data-toggle="dropdown"
                                ...
                                <div class="icon_item_list_catalog_menu">
                                    <svg width="8" height="12" viewBox="0 0 8 12" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <path d="M1.75 1.625L6.10198 5.97698L1.75 10.329" stroke="#22262A" stroke-width="2"
                                              stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
                                </div>
                            </div>
