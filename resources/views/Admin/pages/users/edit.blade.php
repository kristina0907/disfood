            ...
            <div class="col-md-12 m-3">
                <div class="row">
                    <div class="card shadow mb-12">
                        ...
                        <div class="card-body">
                            <form class="user" action="/superadmin/user/update" method="POST">
                                @csrf
                                <input type="hidden" name="id" value="{{$user->id}}">
                                <div class="form-group">
                                    <input type="text" class="form-control " id="name" name="name"  placeholder="Введите имя пользователя..." value="{{$user->name}}">
                                </div>
                                <div class="form-group">
