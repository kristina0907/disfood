                                            ...
                                            @if(!empty($packing))
                                                @foreach($packing as $pack)
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td>
                                                            <a href="/superadmin/packing/edit/{{$pack->id}}" class="btn btn-success btn-circle waves-effect waves-circle waves-float"><i class="material-icons">edit</i></a>
                                                            <a href="/superadmin/packing/delete/{{$pack->id}}" class="btn btn-danger btn-circle waves-effect waves-circle waves-float"><i class="material-icons">delete</i></a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            @endif
