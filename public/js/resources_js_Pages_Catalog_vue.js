...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  }, (0,vuex__WEBPACK_IMPORTED_MODULE_4__.mapActions)('catalog', ['updateValueAction', 'getCatalogData', 'getCatalogTypes', 'updateTypeAction'])),
  mounted: function mounted() {
    this.$store.dispatch('catalog/getCatalogData');
    this.$store.dispatch('catalog/getCatalogTypes');
  },
  computed: _objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_4__.mapState)('catalog', ['categories', 'categoryValue', 'types', 'typeValue', 'filteredTypes', 'products']))
});
                      ...
                      ? _c(
                          "div",
                          {
                            class: {
                              ...
                              "tile_item_tile_item_product_category  col":
                                _vm.tileView
                            }
                          },
                          [
